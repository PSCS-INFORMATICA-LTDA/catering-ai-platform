...
import { fetchFinanceReconciliation } from '@/Lib/payments/fetchFinanceControlCenter'
...
export async function GET(request: Request) {
  ...
  const result = await fetchFinanceReconciliation({ companyId: company.companyId })
  if (result.error) {
