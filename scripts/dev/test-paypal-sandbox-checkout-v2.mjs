...
const policy = read('Lib/payments/paypal/checkoutPolicy.ts')
...
assert.match(readiness, /assertPayPalLiveCheckoutAllowed/)
assert.match(policy, /paypal_webhook_required/)
assert.match(policy, /paypal_test_required/)
...
assert.match(capture, /operationalAdvanceCompleted/)
