...
const dict = {
  pt: {
    ...
    event: 'Evento',
    total: 'Total',
    depositRequired: 'Sinal requerido',
    paidSoFar: 'Pago até agora',
    realBalance: 'Saldo real',
    financeAwaitingDeposit: 'Aguardando sinal',
    financeDepositPaid: 'Sinal pago / parcialmente pago',
    financePaidInFull: 'Quitado',
    financeOperationalError: 'Erro operacional',
    osCreatedAutomatically: 'OS criada automaticamente',
    osPending: 'OS pendente',
    sendGarnishOrder: 'Enviar pedido de guarnições',
    status: 'Status',
    createdAt: 'Criada em',
    actions: 'Ações',
    delete: 'Excluir',
    ...
    openShare: 'Compartilhar proposta',
    openTeam: 'Equipe e designação',
    openInvoice: 'Fatura',
  ...
  en: {
    ...
    financeAwaitingDeposit: 'Awaiting deposit',
    financeDepositPaid: 'Deposit paid / partially paid',
    financePaidInFull: 'Paid in full',
    financeOperationalError: 'Operational error',
    osCreatedAutomatically: 'Service order created automatically',
    osPending: 'Service order pending',
    sendGarnishOrder: 'Send garnish order',
    status: 'Status',
    ...
    loadMore: 'Load more',
    openShare: 'Share proposal',
    openTeam: 'Team assignment',
    openInvoice: 'Invoice',
  ...
  es: {
    ...
    event: 'Evento',
    total: 'Total',
    depositRequired: 'Seña requerida',
    paidSoFar: 'Pagado hasta ahora',
    realBalance: 'Saldo real',
    financeAwaitingDeposit: 'Esperando seña',
    financeDepositPaid: 'Seña pagada / pago parcial',
    financePaidInFull: 'Pagado',
    financeOperationalError: 'Error operacional',
    osCreatedAutomatically: 'OS creada automáticamente',
    osPending: 'OS pendiente',
    sendGarnishOrder: 'Enviar pedido de guarniciones',
    status: 'Estado',
    createdAt: 'Creada el',
    actions: 'Acciones',
    delete: 'Eliminar',
    ...
    loadMore: 'Cargar más',
    openShare: 'Compartir propuesta',
    openTeam: 'Equipo y designación',
    openInvoice: 'Factura',
