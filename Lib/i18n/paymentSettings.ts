...
const { t, list } = makeI18nModule('paymentSettings', 'billing', {
  ...
  recipientName: { pt: 'Nome do destinatário', en: 'Recipient name', es: 'Nombre del destinatario' },
  zelleContact: { pt: 'E-mail ou telefone do Zelle', en: 'Zelle email or phone', es: 'Correo o teléfono de Zelle' },
  zelleContactHint: { pt: 'E-mail ou telefone cadastrado no Zelle', en: 'Email or phone registered with Zelle', es: 'Correo o teléfono registrado en Zelle' },
  instructions: { pt: 'Instruções para o cliente', en: 'Customer instructions', es: 'Instrucciones para el cliente' },
  bankName: { pt: 'Banco', en: 'Bank', es: 'Banco' },
  accountHolder: { pt: 'Titular da conta', en: 'Account holder', es: 'Titular de la cuenta' },
  routingNumber: { pt: 'Routing number', en: 'Routing number', es: 'Routing number' },
  accountNumber: { pt: 'Número da conta', en: 'Account number', es: 'Número de cuenta' },
  zelleEnabled: { pt: 'Zelle ativo para a empresa', en: 'Zelle enabled for this company', es: 'Zelle activo para la empresa' },
  bankEnabled: { pt: 'Transferência bancária ativa para a empresa', en: 'Bank transfer enabled for this company', es: 'Transferencia bancaria activa para la empresa' },
  saveOffline: { pt: 'Salvar Zelle e banco', en: 'Save Zelle and bank', es: 'Guardar Zelle y banco' },
  offlineSaved: { pt: 'Zelle e transferência bancária salvos.', en: 'Zelle and bank transfer saved.', es: 'Zelle y transferencia bancaria guardados.' },
  offlineSecurityNote: {
    pt: 'Cadastre somente dados para receber pagamentos. Nunca informe login, senha, PIN ou código de verificação bancário.',
    en: 'Enter payment receiving details only. Never enter a bank login, password, PIN, or verification code.',
    es: 'Ingrese solo datos para recibir pagos. Nunca informe usuario, contraseña, PIN o código de verificación bancario.',
  },
  statusUnconfigured: {
    pt: 'Não configurado',
    en: 'Not configured',
