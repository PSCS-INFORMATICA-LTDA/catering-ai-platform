...
const dict = {
  pt: {
    ...
    navFinance: 'Visão Geral',
    navFinanceRefunds: 'Reembolsos',
    navFinancePostEvent: 'Pós-evento',
    navFinanceReconciliation: 'Conciliação',
    navFinancePscsOne: 'Integração PSCS One',
    ...
    navInvoices: 'Faturamento',
    navPaypalControl: 'PayPal Control',
    navInventory: 'Estoque',
    navBrasinhaDev: '🔥 Brasinha',
    navBrasinha: '🔥 Brasinha',
    navTeams: 'Equipes',
    navPeople: 'Pessoas',
    navPackages: 'Pacotes',
    navCatalogItems: 'Cadastro de itens',
    navImages: 'Imagens de Pacotes',
    navMedia: 'Mídia',
    ...
    navActivities: 'Atividades e transações',
  ...
  en: {
    ...
    navFinance: 'Overview',
    navFinanceRefunds: 'Refunds',
    navFinancePostEvent: 'Post-event',
    navFinanceReconciliation: 'Reconciliation',
    navFinancePscsOne: 'PSCS One Integration',
    ...
    navActivities: 'Activities and transactions',
  ...
  es: {
    ...
    groupDre: 'PyG',
    groupFinancial: 'Finanzas',
    navFinance: 'Resumen',
    navFinanceRefunds: 'Reembolsos',
    navFinancePostEvent: 'Post-evento',
    navFinanceReconciliation: 'Conciliación',
    navFinancePscsOne: 'Integración PSCS One',
    ...
    navInvoices: 'Facturación',
    navPaypalControl: 'Control PayPal',
    ...
    navImages: 'Imágenes de paquetes',
    navMedia: 'Medios',
    ...
    navActivities: 'Actividades y transacciones',
...
const NAV_HREF_KEY_MAP: Record<string, ChromeMessageKey> = {
  ...
  '/payments/paypal-control': 'navPaypalControl',
  '/finance/refunds': 'navFinanceRefunds',
  '/finance/post-event': 'navFinancePostEvent',
  '/finance/reconciliation': 'navFinanceReconciliation',
  '/finance/pscs-one': 'navFinancePscsOne',
  '/estoque': 'navInventory',
  '/brasinha': 'navBrasinha',
  '/dev/brasinha': 'navBrasinhaDev',
  '/teams': 'navTeams',
  '/customers': 'navPeople',
  '/packages': 'navPackages',
  '/additional-items': 'navCatalogItems',
  '/packages/images': 'navImages',
  '/media/packages': 'navImages',
  '/media': 'navMedia',
  '/commercial-rules': 'navCommercialRules',
  '/coupons': 'navCoupons',
  '/settings/company': 'navCompany',
  '/settings/payments': 'navPayments',
  '/settings/notifications': 'navNotifications',
