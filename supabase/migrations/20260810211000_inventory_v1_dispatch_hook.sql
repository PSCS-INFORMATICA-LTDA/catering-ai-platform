-- =============================================================================
-- Inventory v1 — integra posting de estoque na confirmação pública de saída
-- Se posting falhar (ex.: negative_stock_blocked), a confirmação faz ROLLBACK.
-- =============================================================================
...
BEGIN
  ...
  -- Posting de estoque (mesma transação). Falha → rollback da confirmação.
